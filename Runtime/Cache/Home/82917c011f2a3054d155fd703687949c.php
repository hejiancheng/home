...
/*实现计时器*/
 ...
 function init(){
	 $.ajax({   
        type:"post",     
        url:"<?php echo U('UsersTopic/get_exam_topic');?>", 
        dataType:"json",
        data:{
...
function break_course_list(){
	window.location.href = "<?php echo U('Home/course_list');?>";  
}
function init_show(){
	$(function(){
...
<div>
  ...
  <div class="col-md-10">
    <div class="content">
     ...
     <input type="hidden" id="exam_record_id" value="<?php echo ($id); ?>">
